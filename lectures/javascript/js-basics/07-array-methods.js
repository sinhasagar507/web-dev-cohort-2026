/*
Demonstration of array objects like forEach, map, filter AND reduce()
*/
const orders = [
...
/*
Demonstration of .reduce() to assign values in an object
*/
...
/*
Sort() using the destructure operator
*/
...
/**
 * .toSorted() is the modern, non-mutating version of .sort(). It returns 
 * a brand new sorted array while leaving the original array completely 
 * untouched, avoiding accidental side effects in your data.
 */
